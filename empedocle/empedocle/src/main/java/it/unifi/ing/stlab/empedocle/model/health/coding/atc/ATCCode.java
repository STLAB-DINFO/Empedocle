...
public abstract class ATCCode implements Persistable {
	...
	protected ATCCode parent;
	
	public ATCCode( String uuid ) {
	...
	public ATCCode getParent() {
		return parent;
	}
	public abstract void setParent(ATCCode parent);
